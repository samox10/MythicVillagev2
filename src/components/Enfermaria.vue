...
import { catalogoMedicamentos, tiposFerimentos, infoCategorias, nomeProfissao } from '../dados.js';
...
const loadout = reactive({
    ...
    'pocao': 'pocao_vida_p',
    'ervas': 'ervas_comuns',
    // --- Novos Slots Adicionados ---
    'talas': 'tala_madeira',
    'pomadas': 'pomada_base',
    'antidotos': 'antidoto_p',
    'tonicos': 'tonico_revigorante',
